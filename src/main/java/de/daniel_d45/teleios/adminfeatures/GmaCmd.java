        ...
        try {
            ...
            switch (args.length) {
                case 0:
                    ...
                    try {
                        ...
                        if (player.getGameMode() == GameMode.ADVENTURE) {
                            ...
                            MessageMaster.sendExitMessage("GmaCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the player is already in adventure mode.");
                            return true;
                        }
                        ...
                        MessageMaster.sendExitMessage("GmaCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "success");
                        return true;
                    ...
                    try {
                        ...
                        if (target != sender) {
                            ...
                            if (target == null) {
                                ...
                                MessageMaster.sendExitMessage("GmaCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the specified player is not online.");
                                return true;
                            }
                            ...
                            if (target.getGameMode() == GameMode.ADVENTURE) {
                                ...
                                MessageMaster.sendExitMessage("GmaCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the target is already in adventure mode.");
                                return true;
                            }
                ...
                default:
                    ...
                    MessageMaster.sendExitMessage("GmaCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "wrong amount of arguments.");
                    return false;
            }
