    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            if (!ConfigEditor.isActive("AdminFeatures.All")) {
                ...
                MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the command is deactivated.");
                return true;
            }
            ...
            if (!sender.hasPermission("teleios.adminfeatures.gma")) {
                ...
                MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender doesn't have the needed permissions.");
                return true;
            }
            ...
            switch (args.length) {
                case 0:
                    ...
                    try {
                        ...
                        if (!(sender instanceof Player player)) {
                            ...
                            MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender is not a player.");
                            return true;
                        }
                        ...
                        if (player.getGameMode() == GameMode.SPECTATOR) {
                            ...
                            MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the player is already in spectator mode.");
                            return true;
                        }
                        ...
                        MessageMaster.sendFailMessage("GmspCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", e);
                        return false;
                    }
                case 1:
                    ...
                    try {
                        ...
                        if (target != sender) {
                            ...
                            if (target == null) {
                                ...
                                MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the specified player is not online.");
                                return true;
                            }
                            ...
                            if (target.getGameMode() == GameMode.SPECTATOR) {
                                ...
                                MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the target is already in spectator mode.");
                                return true;
                            }
                ...
                default:
                    ...
                    MessageMaster.sendSkipMessage("GmspCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), wrong amount of arguments.");
                    return false;
            }
