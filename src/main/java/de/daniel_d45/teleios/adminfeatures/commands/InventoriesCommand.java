        ...
        try {
            ...
            switch (args.length) {
                    ...
                    if (args[0].equalsIgnoreCase("list") || args[0].equalsIgnoreCase("remove")) {
                        try {
                            ...
                            if (inventories.length <= 0) {
                                ...
                                MessageMaster.sendSkipMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), there are no inventories.");
                            }
                            ...
                            MessageMaster.sendFailMessage("InventoriesCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), listing all inventories", e);
                            return false;
                        }
                        ...
                        try {
                            ...
                            if (ConfigEditor.getSectionKeys("Inventories") == null) {
                                ...
                                MessageMaster.sendSkipMessage("InventoriesCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), there are no inventories.");
                                return true;
                            }
                        ...
                        MessageMaster.sendSkipMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), wrong arguments.");
                        return false;
                    }
                case 2:
                    ...
                    if (args[0].equalsIgnoreCase("open")) {
                        ...
                        if (!(sender instanceof Player player)) {
                            ...
                            MessageMaster.sendSkipMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender is not a player.");
                            return true;
                        }
                        ...
                        try {
                            ...
                            if (inventory == null) {
                                ...
                                MessageMaster.sendSkipMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), inventory doesn't exist.");
                                return true;
                            }
                            ...
                            MessageMaster.sendFailMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), opening the inventory.", e);
                            return false;
                        }
                    ...
                    // Specifies /inventories remove [Name]
                        ...
                        MessageMaster.sendSkipMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), couldn't find an inventory with this name.");
                        return true;
                    }
                    else {
                        sender.sendMessage("§cWrong arguments!");
                        MessageMaster.sendSkipMessage("InventoriesCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), wrong arguments.");
                        return false;
                    }
                case 3:
                ...
                default:
                    ...
                    MessageMaster.sendSkipMessage("InventoriesCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), wrong amount of arguments.");
                    return false;
            }
