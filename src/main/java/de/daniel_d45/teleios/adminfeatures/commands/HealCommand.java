            ...
            switch (args.length) {
                case 0:
                    ...
                    try {
                        ...
                        if (!(sender instanceof Player player)) {
                            ...
                            MessageMaster.sendSkipMessage("HealCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the target is no player.");
                            return true;
                        }
                ...
                case 1:
                    ...
                    try {
                        ...
                        if (!(sender instanceof Player player)) {
                            sender.sendMessage("§cYou are no player!");
                            MessageMaster.sendSkipMessage("HealCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender is not a player");
                            return true;
                        }
                        ...
                        try {
                            ...
                            if (target != sender) {
                                ...
                                if (wrongGamemode(target)) {
                                    ...
                                    MessageMaster.sendSkipMessage("HealCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the target is not in a suitable gamemode.");
                                    return true;
                                }
                ...
                case 2:
                    ...
                    try {
                        ...
                        MessageMaster.sendSkipMessage("HealCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), wrong arguments.");
                        return false;
                    }
                default:
