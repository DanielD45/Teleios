    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            if (!ConfigEditor.isActive("AdminFeatures.All")) {
                ...
                MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the command is deactivated.");
                return true;
            }
            ...
            if (!sender.hasPermission("teleios.adminfeatures.gma")) {
                ...
                MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the sender doesn't have the needed permissions.");
                return true;
            }
            ...
            switch (args.length) {
                case 0:
                    ...
                    try {
                        ...
                        if (!(sender instanceof Player player)) {
                            ...
                            MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the sender is not a player.");
                            return true;
                        }
                        ...
                        if (player.getGameMode() == GameMode.CREATIVE) {
                            ...
                            MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the player is already in creative mode.");
                            return true;
                        }
                    ...
                    try {
                        ...
                        if (target != sender) {
                            ...
                            if (target == null) {
                                ...
                                MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the specified player is not online.");
                                return true;
                            }
                            ...
                            if (target.getGameMode() == GameMode.CREATIVE) {
                                ...
                                MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "the target is already in creative mode.");
                                return true;
                            }
                ...
                default:
                    ...
                    MessageMaster.sendWarningMessage("GmcCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + ")", "wrong amount of arguments.");
                    return false;
            }
