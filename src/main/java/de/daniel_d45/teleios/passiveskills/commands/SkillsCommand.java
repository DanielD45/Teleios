    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            if (!ConfigEditor.isActive("PassiveSkills.All")) {
                ...
                MessageMaster.sendSkipMessage("SkillsCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), this command is not active");
                return true;
            }
            ...
            if (!(sender instanceof Player player)) {
                ...
                MessageMaster.sendSkipMessage("SkillsCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender is not a player.");
                return true;
            }
            ...
            if (player.hasPermission("teleios.passiveskills.skills")) {
                ...
                MessageMaster.sendSkipMessage("SkillsCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the player doesn't have the needed permissions.");
                return true;
            }
                ...
                case 0:
                    ...
                    try {
                        ...
                        if (SegmentManagerPS.usedSkills.size() > 0) {
                            ...
                            MessageMaster.sendSkipMessage("SkillsCommand", "Skipped method onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), no skills are beeing used.");
                        }
