    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            if (!ConfigEditor.isActive("BetterGameplay.All")) {
                ...
                MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the command is deactivated.");
                return true;
            }
            ...
            if (!sender.hasPermission("teleios.bettergameplay.warp")) {
                ...
                MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender doesn't have the needed permissions.");
                return true;
            }
            ...
            if (!WPsExist && !TPsExist) {
                ...
                MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), there are no warppoints or teleporters.");
                return true;
            }
                ...
                if (TPsExist) {
                    ...
                    for (int i = 0; i < teleporters.length; ++i) {
                        ...
                        try {
                            ...
                            MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the teleporter's location is invalid.");
                            return true;
                        }

                        Location FeetLoc = new Location(currentTPLoc.getWorld(), currentTPLoc.getX(), currentTPLoc.getY() + 1, currentTPLoc.getZ());
                        Location HeadLoc = new Location(currentTPLoc.getWorld(), currentTPLoc.getX(), currentTPLoc.getY() + 2, currentTPLoc.getZ());
            ...
            if (!(sender instanceof Player player)) {
                ...
                MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the sender is not a player.");
                return true;
            }
            ...
            if (TPsExist) {
                ...
                for (String currentTP : teleporters) {
                    ...
                    if (args[0].equalsIgnoreCase(currentTP)) {
                        ...
                        try {
                            ...
                            MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), The teleporter has an invalid location");
                            return false;
                        }
                        ...
                        if (!player.getWorld().equals(TPLoc.getWorld())) {
                            ...
                            MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), player is in the wrong dimension.");
                            return true;
                        }
                        ...
                        try {
                            ...
                            MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the player's warp pouch is invalid.");
                            return true;
                        }
                        ...
                        if (possessedPearls < requiredPearls) {
                            ...
                            MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), the player doesn't have enough ender pearls in their warp pouch.");
                            return true;
                        }
                        ...
                        if ((feetLoc.getBlock().getType() != Material.AIR && feetLoc.getBlock().getType() != Material.CAVE_AIR) || (headLoc.getBlock().getType() != Material.AIR && headLoc.getBlock().getType() != Material.CAVE_AIR)) {
                            ...
                            MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), that teleporter is obstructed.");
                            return true;
                        }
                ...
                MessageMaster.sendSkipMessage("WarpCommand", "onCommand(" + sender + ", " + command + ", " + label + ", " + Arrays.toString(args) + "), wrong arguments.");
                return true;
            }
